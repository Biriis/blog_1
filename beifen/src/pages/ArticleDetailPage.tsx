    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col items-center justify-center h-[60vh]">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">{t('articleNotFound')}</h2>
          <button
            onClick={handleBack}
    ...
    <>
            ...
            <header className="mb-8 pb-8 border-b border-gray-100">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-6">
                <span className="inline-flex items-center gap-2">
                  ...
                  {t('publishDate')}: {new Date(article.publishDate).toLocaleDateString(language === 'en' ? 'en-US' : 'zh-CN', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                  })}
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 mt-16">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; {new Date().getFullYear()} {t('myBlog')}. {t('allRightsReserved')}.</p>
        </div>
      </footer>
