...
import { generateWebsiteSchema, generateArticleListSchema } from '../utils/structuredData';
...
const HomePage: React.FC = () => {
  ...
  const articleListSchema = articles.length > 0 
            ...
            <section className="container mx-auto px-4 py-16 sm:py-20">
              <div className="mb-10 transition-all duration-1000 delay-300 opacity-100 translate-y-0">
                <div className="flex items-center gap-4">
                  <div>
                    ...
                    <p className="text-white/60">{t('discoverContent')}</p>
                  </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-20 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 transition-all duration-1000 delay-500 opacity-100 translate-y-0">
                  ...
                  <p className="text-white text-lg mb-2">{t('noArticles')}</p>
                  <p className="text-white/60 text-sm">{t('stayTuned')}</p>
                </div>
              ) : (
